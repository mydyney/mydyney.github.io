...
Today, I'll introduce the trendy **Human Made** offline store located in Shibuya Parco.

Recently, the Human Made store in Shibuya Parco has undergone a renewal and expansion! Before, everything was gathered in one place, making it extremely crowded. Now, it has been separated into **PART 1 (Clothing)** and **PART 2 (General Goods)** to provide a more pleasant shopping environment.
...
**PART 1** is the space where mainly **clothing** is displayed. It is located inside the Parco building, so it is easy to find.

*   **Location:** Shibuya Parco 1F (Inside)
*   **Items:** T-shirts, hoodies, varsity jackets, padding, pants, outerwear, etc.
*   **Vibe:** A spacious layout where you can leisurely look at clothes and try them on.
...
If you are looking for Human Made's signature graphic t-shirts or outerwear, you must visit **PART 1**.
...
**PART 2** is a space that collects **accessories and lifestyle goods**. Be careful as it is located **outside** the Parco building, not inside!
...
It is a newly created space and **does not connect from inside the Parco building!** You must go out to the 1st floor.

*   **Location:** Shibuya Parco 1F Exterior
*   **Items:** Keyrings, hats, bags, lifestyle goods
*   **How to get there:** Follow the alley between the Parco buildings to see the dedicated entrance.
...
Since most of the popular keyrings and hats are gathered here, if your goal is accessories, head straight to **PART 2**.
...
There is also a curry shop produced by Human Made called **CURRY UP** nearby.
...
*   **Menu:** Keema curry, butter chicken curry, etc.
...
*   **Clothing** -> **PART 1** (Inside Parco 1F)
*   **Accessories/Goods** -> **PART 2** (Outside Parco 1F)
*   **Waiting** -> Scan QR code on site
