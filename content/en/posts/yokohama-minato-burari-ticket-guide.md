---
title: "Yokohama Transport Pass: Minato Burari Ticket Guide & 1-Day Itinerary Map"
date: 2025-08-19T19:56:00+09:00
draft: false
translationKey: "yokohama-minato-burari-ticket-guide"
description: "Everything you need to know about the Yokohama Minato Burari Ticket. A complete guide to transport passes, 1-day travel routes, and an exclusive travel map for your Tokyo day trip."
summary: "Discover the best way to explore Yokohama with the Minato Burari Ticket. This guide covers ticket prices, where to buy, and a complete 1-day itinerary map."
tags: ["yokohama", "minato-burari-ticket", "tokyo-day-trip", "japan-travel-tips", "transport-pass"]
...
<p style="text-align: center; font-size: 1.1rem; color: #555;">Only 30 minutes from Tokyo by train!<br>
Yokohama is a charming city with Chinatown, Red Brick Warehouse,<br>
Landmark Tower, and stunning sea views.<br>
The essential transport pass for your trip is the Minato Burari Ticket!!</p>

<figure>
  <img src="/images/posts/yokohama-minato-burari-ticket-guide-01.jpg" alt="Yokohama Minato Burari Ticket Guide Cover">
</figure>
...
<h2>🎫 Minato Burari Ticket Types & Prices</h2>

<div class="info-box">
  <ul>
    <li>✔️ Unlimited rides for one day in the Yokohama bay area</li>
    <li>✔️ Covers Subway, Circular Sightseeing Buses, and City Buses</li>
    <li>✔️ Includes special discounts at various attractions and shops</li>
    <li>(e.g., 100 yen discount for Sankeien Garden admission)</li>
  </ul>
</div>
...
<table class="schedule-table">
  <thead>
    <tr>
      <th>Ticket Type</th>
      <th>Adult</th>
      <th>Child (Under 12)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td><strong>Minato Burari Ticket</strong></td>
      <td>700 yen</td>
      <td>350 yen</td>
    </tr>
    <tr>
      <td><strong>Minato Burari Ticket Wide</strong><br>(Includes Shin-Yokohama Station)</td>
      <td>750 yen</td>
      <td>380 yen</td>
    </tr>
  </tbody>
...
<ul>
  <li><strong>Municipal Subway Blue Line:</strong> Yokohama Station to Yoshinocho Station (Wide version includes Shin-Yokohama)</li>
  <li><strong>Four Circular Sightseeing Buses:</strong>
    <ul>
      <li>Bayside Blue</li>
      <li>Akai Kutsu (Red Shoes)</li>
      <li>Burari Nogeyama Zoo Bus (N Route)</li>
      <li>Burari Sankeien Bus (S Route - Weekends/Holidays only)</li>
    </ul>
  </li>
  <li><strong>City Bus & Kanagawa Central Bus:</strong> Major sections including Yokohama Station, Motomachi, and Sankeien Garden</li>
</ul>
...
<div class="tip-box">
  ...
  <p style="text-align: center;"><a href="https://affiliate.klook.com/redirect?aid=110453&aff_adid=1208343&utm_source=tripmate&utm_campaign=bulk-update-2026&k_site=https%3A%2F%2Fwww.klook.com%2Fen-US%2Factivity%2F111555-minato-burari-ticket%2F%3Fcurrency%3DUSD%26n_currency%3DUSD%26ignore_ip%3D1" target="_blank" style="font-weight: bold; color: #aa1f91;">➡️ Book Yokohama Minato Burari Ticket on Klook</a></p>
</div>
