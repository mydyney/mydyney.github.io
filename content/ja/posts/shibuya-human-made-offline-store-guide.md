...
HUMAN MADEは非常に人気があるため、基本的に並ぶことが多いです。

*   **平日:** 待ち時間なくすぐに入店できることが多いです。
*   **土日祝:** 待機列ができる可能性が高いです。
*   **発売日:** 新商品の発売日などは整理券が必要になる場合があります。

列ができている場合は、スタッフの指示に従って**QRコード**を読み込み、順番待ちの登録をします。順番が来るとスマホに通知が届くシステムなので、待ち時間はパルコ内を自由に見て回ることができます。
