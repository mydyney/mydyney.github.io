...
HUMAN MADEは、<b>ドロップ日（新作発売日の土曜日）</b>やコラボ発売日における店舗の混雑を防ぐため、<b>整理券システム（入店順位決定券）</b>を導入しています。

### 🎫 整理券とは？
あくまで<b>「入店の順番」を決める券</b>であり、<b>「商品購入確約券」ではありません</b>。
整理券を持って入店しても、自分の番になった時にはお目当ての商品が売り切れている場合もあります。

### 📢 配布方式（抽選 vs 先着）
発売日によって運営方法が異なります。必ず<b>公式Instagramの告知</b>を確認してください。

💖 [HUMAN MADE 公式 NEWS](https://humanmade.jp/)
💖 [HUMAN MADE 公式 Instagram](https://www.instagram.com/humanmade/)

*   <b>ランダム抽選（一般的）:</b> 指定された時間・場所に集まった人にランダムで番号を配布します。（ハズレ券を引くと入店できません）
*   <b>先着順:</b> 並んだ順に番号を配布します。（人気商品は瞬殺されることもあります）

### 📌 整理券の受け取り方・注意点
*   <b>配布場所:</b> 通常、<b>渋谷パルコ1Fの外部通路</b>で配布されます。当日はスタッフのプラカードをよく確認してください。
*   <b>必須の持ち物:</b> <b>パスポート（顔写真付き身分証）必須！</b> 本人確認は非常に厳格に行われます。
*   <b>注意:</b> 転売防止のため、<b>1人1枚</b>の制限が徹底されています。集合時間に遅れると配布が終了してしまうので、時間に余裕を持って到着しましょう。

通常の平日は、店頭の<b>QRコード</b>を読み込んで順番待ちをするスタイルが一般的です。

---

## 2. PART 1: ウェア専門店 (パルコ館内)

<b>PART 1</b>は、主に<b>アパレル（ウェア）</b>が展示されているスペースです。こちらはパルコの建物内にあるので、すぐに見つけることができます。

*   <b>場所:</b> 渋谷パルコ 1F（館内）
*   <b>取り扱い:</b> Tシャツ、パーカー、スタジャン、ダウン、パンツ、アウターなど
*   <b>雰囲気:</b> 広々としたレイアウトで、ゆっくりと服を見たり試着したりできます。
...
<b>PART 2</b>は、<b>アクセサリーやライフスタイルグッズ</b>を集めたスペースです。注意点として、こちらはパルコの館内ではなく<b>外</b>にあります！
...
*   <b>場所:</b> 渋谷パルコ 1F 外側
*   <b>取り扱い:</b> キーリング、帽子、バッグ、ライフスタイル雑貨
*   <b>行き方:</b> パルコの建物間の路地（オルガン坂側）を進むと専用の入り口が見えます。
...
近くには、HUMAN MADEがプロデュースするカレーショップ<b>CURRY UP</b>もあります。
...
*   <b>雰囲気:</b> NIGO氏の感性が感じられるヒップな空間
*   <b>グッズ:</b> カレー皿やスプーンなど、可愛いグッズも販売されています
...
*   <b>価格帯:</b> Tシャツ 約1万円〜、パーカー 約3万円〜、アウター 約8万円〜。
*   <b>サイズ感:</b> 日本規格のため、身幅が細めでスリムな作りです。普段より<b>1〜2サイズアップ</b>することを強くおすすめします。
*   <b>免税 (Tax Free):</b> 渋谷パルコは免税対応店舗です。必ずパスポートを持参してください！（※一部コラボ商品は対象外の場合あり）
...
*   <b>ウェア</b> → <b>PART 1</b> (パルコ館内 1F)
*   <b>小物・雑貨</b> → <b>PART 2</b> (パルコ館外 1F)
*   <b>入店待ち</b> → 現地でQRコード受付
