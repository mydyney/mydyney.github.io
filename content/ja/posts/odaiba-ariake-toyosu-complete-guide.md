...
<p style="text-align: center; font-size: 1.1rem; color: #555;">🌊 東京ウォーターフロントの楽園へ!<br>
豊洲・有明・お台場を1日で完全制覇,<br>
新鮮な海鮮料理から未来的なアート体験まで,<br>
...
<p><strong>💡 関連ガイド:</strong> <a href="#" style="color: #667eea;">東京メトロパスvsJR都内パス比較</a> - 他の電車路線も利用する場合は、こちらの総合パス比較ガイドをご確認ください。</p>
...
<p>効率よく3エリアを回る、6ステップのおすすめコースをご紹介します:</p>
...
<table class="schedule-table">
  ...
  <tbody>
    ...
    <tr>
      <td>16:00</td>
      <td>お台場</td>
      <td>観光(自由の女神像、ガンダム、レインボーブリッジ)</td>
    </tr>
    <tr>
      <td>夕方</td>
      <td>お台場</td>
...
<div class="info-box">
  <h3>♨️ 万葉倶楽部豊洲</h3>
  <ul>
    <li><strong>住所:</strong> 東京都江東区豊洲2-2-1(ららぽーと豊洲6F)</li>
    <li><strong>営業時間:</strong> 24時間営業</li>
    <li><strong>料金:</strong> 平日2,970円 / 土日祝3,520円(タオル・館内着込み)</li>
    <li><strong>設備:</strong> 複数の内湯・露天風呂、サウナ、リラクゼーションルーム</li>
    <li><strong>注意:</strong> タトゥー禁止(日本の温泉では一般的)</li>
  </ul>
</div>
...
<div class="info-box">
  <h3>🎨 チームラボプラネッツ東京</h3>
  <ul>
    <li><strong>住所:</strong> 東京都江東区豊洲6-1-16</li>
    <li><strong>最寄駅:</strong> 新豊洲駅(ゆりかもめ)から徒歩8分</li>
    <li><strong>営業時間:</strong> 9:00〜21:00(最終入場20:00)</li>
    <li><strong>料金:</strong> 大人3,800円 / オンライン事前予約推奨</li>
    <li><strong>所要時間:</strong> 60〜90分推奨</li>
    <li><strong>注意:</strong> 裸足必須、膝上までのショートパンツ・スカート着用(水の中を歩きます)</li>
  </ul>
</div>
...
<div class="info-box">
  <h3>🛒 有明ガーデン</h3>
  <ul>
    <li><strong>住所:</strong> 東京都江東区有明2-1-8</li>
    <li><strong>最寄駅:</strong> 有明駅(ゆりかもめ)または有明テニスの森駅(りんかい線)</li>
    <li><strong>営業時間:</strong> 10:00〜21:00(飲食店は23:00まで)</li>
    <li><strong>フロア:</strong> 地下2階〜地上5階</li>
    <li><strong>見どころ:</strong> 無印良品旗艦店、紀伊國屋書店、多様なフードコート</li>
  </ul>
</div>
...
<p>有明アリーナは、東京2020オリンピックでバレーボール競技が行われた多目的施設です。現在はコンサート、スポーツイベント、展示会が開催されています。イベント参加に興味がある場合は、事前にスケジュールを確認しましょう。</p>

<h2>🗼 お台場エリア:エンターテイメント&ランドマーク</h2>
...
<div class="info-box">
  <h3>📸 必見撮影スポット</h3>
  <ul>
    <li><strong>自由の女神像:</strong> 夕暮れ時(冬季17:00〜18:00)がベスト</li>
    <li><strong>レインボーブリッジ:</strong> 日没後にライトアップ(季節により異なる)</li>
    <li><strong>RX-93ff νガンダム:</strong> ダイバーシティ東京プラザの実物大24.8m立像</li>
    <li><strong>フジテレビ本社ビル:</strong> 球体展望室のある特徴的な建築</li>
    <li><strong>パレットタウン大観覧車:</strong> 東京湾のパノラマビュー</li>
  </ul>
</div>
...
<p>ダイバーシティ東京プラザのガンダム立像は、お台場で最も人気のあるアトラクションの一つです。この立像は1日を通じて決まった時間にダイナミックなポーズやライトショーを披露します。</p>
...
<div class="info-box">
  <h3>🏢 ダイバーシティ東京プラザ</h3>
  <ul>
    <li><strong>住所:</strong> 東京都江東区青海1-1-10</li>
    <li><strong>最寄駅:</strong> 東京テレポート駅(りんかい線)またはお台場駅(ゆりかもめ)</li>
    <li><strong>営業時間:</strong> ショッピング 10:00〜21:00 / レストラン 11:00〜23:00</li>
    <li><strong>見どころ:</strong> H&M、ZARA、ユニクロ、ガンダムベース東京、ラウンドワンアミューズメント</li>
    <li><strong>飲食:</strong> 6F〜7Fに30以上の多彩なレストラン</li>
  </ul>
</div>
...
<div class="info-box">
  <h3>🍜 ラーメン国技館 東京(6F)</h3>
  <ul>
    <li><strong>コンセプト:</strong> 6つの地域別ラーメン店が一堂に会する</li>
    <li><strong>店舗:</strong> 東京、北海道、九州などの有名店の入れ替わりセレクション</li>
    <li><strong>価格:</strong> 1杯900円〜1,500円</li>
    <li><strong>営業時間:</strong> 11:00〜23:00(ラストオーダー22:30)</li>
    <li><strong>人気:</strong> 日本各地を旅せずに異なるスタイルのラーメンを試せる</li>
  </ul>
</div>
...
<div class="info-box">
  ...
  <ul>
    <li><strong>台場一丁目商店街:</strong> ノスタルジックな1950年代の日本の商店街を再現(3F〜4F)</li>
    <li><strong>レゴランド・ディスカバリー・センター:</strong> ファミリー向け屋内LEGOアトラクション</li>
    <li><strong>マダム・タッソー東京:</strong> 有名人のフィギュアを展示する蝋人形館</li>
    <li><strong>たこ焼きミュージアム:</strong> 大阪の有名たこ焼き店5店舗(5F)</li>
  </ul>
</div>
...
<p>イマーシブ・フォート東京は2024年に旧ヴィーナスフォートの場所にオープンしました。人気フランチャイズに着想を得たイマーシブシアター体験やエンターテイメントショーを提供しています。</p>

<div class="info-box">
  <h3>🎭 イマーシブ・フォート東京</h3>
  <ul>
    <li><strong>住所:</strong> 東京都江東区青海1-3-15(パレットタウン跡地)</li>
    <li><strong>最寄駅:</strong> 青海駅(ゆりかもめ)</li>
    <li><strong>営業時間:</strong> 10:00〜22:00(ショーにより異なる)</li>
    <li><strong>チケット:</strong> アトラクションにより異なる、事前予約推奨</li>
    <li><strong>ショー:</strong> 東京リベンジャーズ、シャーロック・ホームズ、ホラー体験など</li>
  </ul>
</div>
...
<div class="info-box">
  <h3>🚃 交通手段</h3>
  <ul>
    <li><strong>ゆりかもめ:</strong> 新橋〜豊洲(ウォーターフロントの景色が楽しめる無人運転モノレール)</li>
    <li><strong>りんかい線:</strong> 大崎や渋谷でJR線と接続</li>
    <li><strong>水上バス:</strong> 浅草や日の出桟橋から景色を楽しむ船旅</li>
    <li><strong>東京ベイシャトル:</strong> 主要なお台場施設間を結ぶ無料シャトルバス</li>
  </ul>
</div>
...
<!-- TODO: Update link after migration
     Naver: https://blog.naver.com/tokyomate/224025699867
     Hugo: /ja/posts/[SLUG_TBD]/ -->
<p><strong>🎫 パス比較:</strong> <a href="#" style="color: #667eea;">東京メトロパスvsJRパス - どちらを買うべき?</a></p>
...
<table class="schedule-table">
  ...
  <tbody>
    ...
    <tr>
      <td>お台場</td>
      <td>アクアシティ、デックス東京ビーチ</td>
    </tr>
    <tr>
      <td>お台場海浜公園</td>
      <td>自由の女神像、お台場海浜公園</td>
    </tr>
    <tr>
      <td>青海</td>
      <td>ダイバーシティ東京プラザ、イマーシブ・フォート東京</td>
    </tr>
  </tbody>
</table>
...
<p>お台場の立地は、他の東京観光エリアとの組み合わせも簡単です:</p>

<div class="info-box">
  <h3>🗺️ おすすめエリア組み合わせ</h3>
  <ul>
    <li><strong>浅草と:</strong> 浅草からお台場まで水上バスで(40分の景色の良い旅)</li>
    <li><strong>品川と:</strong> りんかい線でJR線に接続(15分)</li>
    <li><strong>渋谷/新宿と:</strong> りんかい線で大崎経由、その後JR山手線</li>
    <li><strong>築地と:</strong> タクシーで短距離、または早朝市場訪問と組み合わせ</li>
  </ul>
</div>
...
<!-- TODO: Update link after migration
     ...
     Hugo: /ja/posts/[SLUG_TBD]/ -->
<p><strong>🏮 浅草の午前:</strong> <a href="#" style="color: #667eea;">東京浅草完全ガイド - 浅草寺&必見スポット</a></p>

<h2>💡 訪問の必須ヒント</h2>

<div class="tip-box">
  <p><strong>⏰ タイミングのヒント:</strong></p>
  <ul>
    <li>豊洲市場は早めに訪問(8時前)して混雑を避ける</li>
    <li>チームラボプラネッツ:混雑が少ない10:00〜11:00の時間帯を予約</li>
    <li>夕日の写真を撮るため、17時までにお台場のランドマークに到着</li>
    <li>平日は週末より大幅に空いている</li>
    <li>水曜日は豊洲市場が休場なので避ける</li>
  </ul>
</div>
...
<div class="tip-box">
  ...
  <ul>
    <li>3駅以上訪問する場合はゆりかもめ一日乗車券を購入(820円)</li>
    <li>チームラボプラネッツのチケットはオンライン予約で割引</li>
    <li>多くのショッピングモールで旅行者向け免税ショッピング可能</li>
    <li>フードコートは通常レストランより安い</li>
    <li>フジテレビビルや一部のモールの展望デッキは無料</li>
  </ul>
</div>

<div class="tip-box">
  <p><strong>👕 服装/持ち物:</strong></p>
  <ul>
    <li>歩きやすい靴(15,000歩以上歩きます)</li>
    <li>チームラボプラネッツ:膝上のショートパンツ・スカート着用、荷物用ビニール袋持参</li>
    <li>温泉:小タオル持参(現地でレンタル可能)</li>
    <li>冬季:屋外観光用にジャケット持参(水辺は風が強いことがあります)</li>
    <li>写真撮影用にモバイルバッテリー(たくさん撮ります!)</li>
  </ul>
</div>
...
<table class="schedule-table">
  ...
  <tbody>
    <tr>
      <td>冬(12月〜2月)</td>
      <td>イルミネーション</td>
      <td>レインボーブリッジと各モールがライトディスプレイを実施</td>
    </tr>
    <tr>
      <td>春(4月)</td>
      <td>桜</td>
    ...
    <tr>
      <td>夏(7月〜8月)</td>
      <td>ビーチアクティビティ</td>
      <td>お台場ビーチでビーチバレー、ウォータースポーツ</td>
    </tr>
    <tr>
      <td>12月</td>
      <td>レインボー花火</td>
      <td>土曜日の花火ショー(スケジュール要確認)</td>
    </tr>
  </tbody>
</table>
...
<div class="info-box">
  <ul>
    <li>☑️ ゆりかもめ一日乗車券(または十分な残高のあるICカード)</li>
    <li>☑️ チームラボプラネッツのチケット(オンライン事前予約)</li>
    <li>☑️ 豊洲市場の休場日スケジュール確認済み</li>
    <li>☑️ 歩きやすい靴</li>
    <li>☑️ モバイルバッテリーとカメラ/スマートフォン</li>
    <li>☑️ 軽いジャケット(ウォーターフロントは風が強い可能性)</li>
    <li>☑️ 免税ショッピング用パスポート</li>
  </ul>
</div>
