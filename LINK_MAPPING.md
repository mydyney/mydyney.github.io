...
1. **Find Mappings:** Search (Cmd+F) for the Naver ID or Slug.
2. **Add New Mappings:** Add an entry to the **Master Mapping Table** with status `⏳` (Planned) or `✅` (Complete).
3. **Synchronize:** Ensure the `declare -A MAPPINGS` array at the bottom matches the table.
4. **Run Script:** Use the shell script block to batch replace links in the codebase.

---

## Master Mapping Table

| Naver ID | Hugo Slug | Status | Description/Note |
|----------|-----------|--------|------------------|
| 224129178083 | tokyo-toshikoshi-soba-new-year-eve-guide | ✅ | |
| 224125943419 | tokyo-3-day-itinerary-landmark-series | ✅ | |
| 224124979714 | tokyo-3-day-itinerary-disney-shibuya-sky | ✅ | |
| 224123307702 | tokyo-january-1-onsen-spa-24-hours | ✅ | |
| 224122259609 | tokyo-sunrise-spots-2026 | ✅ | |
| 224121730136 | tokyo-countdown-2026 | ✅ | |
| 224114567793 | tokyo-station-ekiben-guide | ✅ | |
...
| 224111977613 | tokyo-station-character-street-guide | ✅ | |
| 224110207709 | tokyo-station-year-end-hours-2026 | ✅ | |
...
| 224104602398 | tokyo-station-sawamura-lunch | ✅ | |
| 224104049826 | shibuya-miyashita-park-yokocho-2025 | ✅ | |
| 224102752117 | tokyo-year-end-business-hours-2026 | ✅ | |
| 224101626196 | shinjuku-chuo-park | ✅ | |
...
| 223681272647 | evangelion-30th-roppongi-2025, roppongi-hills-hello-kitty-popup-2025 | ⏳ | |
...
## Link Conversion Script (Automation)

Use this script to batch replace Naver blog links with Hugo internal links across all language versions.

```bash
#!/bin/bash

# Configuration: Naver ID to Hugo Slug Mapping
declare -A MAPPINGS=(
  ["224129178083"]="tokyo-toshikoshi-soba-new-year-eve-guide"
  ["224125943419"]="tokyo-3-day-itinerary-landmark-series"
  ["224124979714"]="tokyo-3-day-itinerary-disney-shibuya-sky"
...
- This file is the **Single Source of Truth** for link conversion.
- Update the table first, then the script array.
- Use `⏳` for planned migrations to reserve slugs and prevent duplicates.
